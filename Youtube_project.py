api_key='AIzaSyCtd4UqBFbdlOlrMT9QMk89FD7akki1MwY'
...
aravinth =psycopg2.connect(host="localhost",user="postgres",password="aravinth8248",port=5432,database= "youtube_data")
...
aravinth_DB=pymongo.MongoClient("mongodb+srv://aravinth:aravinth1234@cluster0.duefcos.mongodb.net/", tlsCAFile=ca) #copy the link from mongodb altas to establish connection and enter your password

db=aravinth_DB["Youtube_Project"]
col=db["Channels"]
